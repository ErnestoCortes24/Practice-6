...
Para la práctica 6, fue similar a la práctica anterior (practice-5), donde se observó cuales son los comportamientos en cada puerto del microprocesador virtual, pero en este caso no era la el objetivo de la práctica. El objetivo de la práctica original era el encendido de un display por medio de LEDs, por medio del método de multiplexación, ya que nos ayuda a la reducción de entradas y salidas. A pesar de ello, se tenía la intención de hacer un gráfico en donde podía simular la pantalla de LEDS. En este caso, al no haber una licencia para utilizar dicho software, se simulará como en la práctica 5 en el debugueador de MPLabX.
